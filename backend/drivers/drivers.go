...
type DriverDTO struct {
	...
	LicenseNumber             string  `json:"license_number" redis:"license_number"`
	PrimaryPhoneNumber        *string `json:"primary_phone_number,omitempty" redis:"primary_phone_number,omitempty"`
	PrimaryPhoneCountryCode   *string `json:"primary_phone_country_code,omitempty" redis:"primary_phone_country_code,omitempty"`
	SecondaryPhoneNumber      *string `json:"secondary_phone_number,omitempty" redis:"secondary_phone_number,omitempty"`
	SecondaryPhoneCountryCode *string `json:"secondary_phone_country_code,omitempty" redis:"secondary_phone_country_code,omitempty"`
	Email                     *string `json:"email,omitempty" redis:"email,omitempty"`
	Status                    *uint8  `json:"status,omitempty" redis:"status,omitempty"`
}
